...
bank[748596]["profile"]["contact"]["email"]=["sajwa@example.com"]
bank[748596]["profile"]["contact"]["email"].append("sajwa07@example.com")
print(bank[748596]["profile"]["contact"]["email"])